...
public class PersonState {
    ...
    public double lerpX(float tickProgress) {
        return MathHelper.lerp(tickProgress, this.lastX, this.x);
    }

    public double lerpY(float tickProgress) {
        return MathHelper.lerp(tickProgress, this.lastY, this.y);
    }

    public double lerpZ(float tickProgress) {
        return MathHelper.lerp(tickProgress, this.lastZ, this.z);
    }
